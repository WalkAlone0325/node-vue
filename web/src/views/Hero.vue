  ...
  <div class="page-hero" v-if="model">
    ...
    <div>
      <div class="top" :style="{'background-image': `url(${model.banner})`}">
        <div class="info h-100 text-white p-3 d-flex flex-column jc-end">
        ...
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bottom">
              <div class="d-flex">
                <router-link to="/" class="btn btn-lg flex-1" tag="button">
                  <i class="iconfont icon-Menu"></i>
                  英雄介绍视频
                </router-link>
                <router-link to="/" class="btn btn-lg flex-1 ml-2" tag="button">
                  <i class="iconfont icon-Menu"></i>
                  一图识英雄
                </router-link>
              </div>
            ...
            <m-card plain icon="Menu" title="英雄关系">
              <div v-for="item in model.partners" :key="item.name" class="d-flex pt-4">
                ...
                <p class="flex-1 ml-3 m-0" ml-3>{{item.description}}</p>
              </div>>
              <div class="border-bottom mt-3"></div>
            </m-card>
          </div>
